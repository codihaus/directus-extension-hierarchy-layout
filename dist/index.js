import { useApi, useSync, defineLayout, useCollection, useItems, getFieldsFromTemplate } from '@directus/extensions-sdk';
import * as vue from 'vue';
import { defineComponent, ref, computed, resolveComponent, resolveDirective, openBlock, createElementBlock, createVNode, normalizeClass, withCtx, createBlock, createElementVNode, withDirectives, withModifiers, unref as unref$1, createCommentVNode, renderSlot, mergeProps, Fragment, toDisplayString, isRef, toRefs } from 'vue';
...
const _hoisted_1$2 = { class: "forest-view-wrap" };
const _hoisted_2$1 = {
  class: "",
  style: { "flex-grow": "1" }
};
var _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "v-hierarchy-wrap",
  props: {
    item: {},
    optTitle: {},
    collection: {},
  ...
  setup(__props) {
    ...
    const checkedIcon = computed(() => {
      var _a;
      return ((_a = props.selection) == null ? void 0 : _a.indexOf(props.item.id)) >= 0 ? "check_circle" : "radio_button_unchecked";
    });
    const selectedClass = computed(() => {
      var _a;
      return ((_a = props.selection) == null ? void 0 : _a.indexOf(props.item.id)) >= 0 ? "selected" : "";
    });
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createVNode(_component_v_list_item, {
          ...
          dense: "",
          clickable: "",
          class: normalizeClass(["group", selectedClass.value]),
          onClick: _cache[1] || (_cache[1] = ($event) => _ctx.edit({ item: _ctx.item, event: $event }))
        }, {
          default: withCtx(() => [
            createVNode(_component_v_list_item_icon, null, {
              default: withCtx(() => [
                _ctx.selectMode ? (openBlock(), createBlock(_component_v_icon, {
                  key: 0,
                  name: checkedIcon.value
                }, null, 8, ["name"])) : (openBlock(), createBlock(_component_v_icon, {
                  key: 1,
                  class: "drag-handle",
                  name: "drag_handle"
                }))
            ...
            createElementVNode("div", _hoisted_2$1, [
              createVNode(_component_render_template, {
                ...
                item: _ctx.item,
                template: _ctx.optTitle
              }, null, 8, ["collection", "item", "template"])
            ]),
            createElementVNode("div", null, [
              _ctx.hasChildren ? withDirectives((openBlock(), createBlock(_component_v_icon, {
                key: 0,
                name: expand.value ? "unfold_less" : "unfold_more",
                class: normalizeClass([expand.value ? "unfold_less" : "unfold_more", "collapse-toggle"]),
                clickable: "",
                onClick: _cache[0] || (_cache[0] = withModifiers(($event) => expand.value = !expand.value, ["stop", "prevent"]))
              }, null, 8, ["name", "class"])), [
                [_directive_tooltip, expand.value ? unref$1(t)("collapse") : unref$1(t)("expand")]
        ...
        expand.value ? renderSlot(_ctx.$slots, "default", { key: 0 }, void 0, true) : createCommentVNode("v-if", true)
      ]);
    };
  }
});
...
var css$1 = "\n.collection-item[data-v-5c3736e3] {\n\tmargin-top: 8px;\n}\n.unfold_less[data-v-5c3736e3] {\n\topacity: 0.4;\n}\n.forest-view-wrap .group.selected[data-v-5c3736e3] {\n\tbackground-color: var(--theme--background-normal) !important;\n\tborder-color: var(--theme--primary-subdued) !important;\n}\n";
n(css$1,{});
...
var VHierarchyWrap = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-5c3736e3"], ["__file", "v-hierarchy-wrap.vue"]]);

var _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "v-hierarchy-item",
  props: {
    items: {},
  ...
  emits: ["edit", "delete", "update:items"],
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      const _component_v_hierarchy_item = resolveComponent("v-hierarchy-item", true);
      return openBlock(), createBlock(unref$1(draggable), mergeProps({
        modelValue: itemsRender.value,
        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => itemsRender.value = $event),
        group: "hierarchy",
        class: [_ctx.children ? "drag-container" : "root-drag-container", "v-forrest-item"],
        "item-key": "id",
        handle: ".drag-handle",
        "swap-threshold": 0.3
      }, { "force-fallback": true }), {
        item: withCtx(({ element, index }) => [
          createVNode(VHierarchyWrap, {
            item: element,
            "opt-title": _ctx.optTitle,
            collection: _ctx.collection,
            "has-children": element.sub_items.length > 0,
            edit: _ctx.edit,
            selectMode: _ctx.selectMode,
            selection: _ctx.selection,
            optTitle: _ctx.optTitle,
            optParentField: _ctx.optParentField
          }, {
            default: withCtx(() => [
              createVNode(_component_v_hierarchy_item, {
                ...
                optParentField: _ctx.optParentField,
                edit: _ctx.edit
              }, null, 8, ["items", "collection", "parent", "selectMode", "selection", "optTitle", "optParentField", "edit"])
            ]),
            _: 2
            /* DYNAMIC */
          }, 1032, ["item", "opt-title", "collection", "has-children", "edit", "selectMode", "selection", "optTitle", "optParentField"])
        ]),
        _: 1
        /* STABLE */
      }, 16, ["modelValue", "class"]);
...
var VHierarchyItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "v-hierarchy-item.vue"]]);

function useBuildForest(data, parentField) {
  const nodes = {};
  data.forEach((item) => {
  ...
  setup(__props) {
    ...
    const updateItems = async (vl) => {
      ...
      for (let vlItem of items) {
        const item = props.items.find((item2) => item2.id === vlItem.id);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(
        ...
        _hoisted_1$1,
        [
          createVNode(_component_v_list, { class: "draggable-list" }, {
            default: withCtx(() => [
              createVNode(VHierarchyItem, {
                items: itemsRenders.value,
                "onUpdate:items": updateItems,
                onDelete: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("delete", $event)),
                optTitle: _ctx.optTitle,
                optParentField: _ctx.optParentField,
                collection: _ctx.collection,
                parent: null,
                edit: _ctx.onItemClick,
                selectMode: _ctx.selectMode,
                selection: _ctx.selection,
                children: ""
              }, null, 8, ["items", "optTitle", "optParentField", "collection", "edit", "selectMode", "selection"])
            ]),
            _: 1
            /* STABLE */
          })
...
var css = "\n.layout-hierarchy[data-v-406135ce] {\n\tpadding: var(--content-padding);\n\tpadding-top: 0;\n}\n.layout-hierarchy .v-forrest-item[data-v-406135ce] {\n\tmargin-bottom: 8px;\n}\n.layout-hierarchy[data-v-406135ce] .root-drag-container {\n\tpadding: 8px 0;\n\toverflow: hidden;\n}\n.layout-hierarchy[data-v-406135ce] .drag-container {\n\tmargin-top: 8px;\n\tmargin-left: 20px;\n}\n.draggable-list[data-v-406135ce] .sortable-ghost {\n.v-list-item[data-v-406135ce] {\n\t\t--v-list-item-background-color: var(--theme--primary-background);\n\t\t--v-list-item-border-color: var(--theme--primary);\n\t\t--v-list-item-background-color-hover: var(--theme--primary-background);\n\t\t--v-list-item-border-color-hover: var(--theme--primary);\n> *[data-v-406135ce] {\n\t\t\topacity: 0;\n}\n}\n}\n\n";
n(css,{});

var LayoutComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-406135ce"], ["__file", "layout.vue"]]);

const _hoisted_1 = { class: "field" };
const _hoisted_2 = { class: "type-label" };
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["update:optTitle", "update:optParentField"],
  setup(__props, { emit: __emit }) {
    const { t } = useI18n();
    const props = __props;
    const emit = __emit;
    ...
    return (_ctx, _cache) => {
      ...
      const _component_v_collection_field_template = resolveComponent("v-collection-field-template");
      return openBlock(), createElementBlock(
        Fragment,
        null,
        [
          createElementVNode("div", _hoisted_1, [
            createElementVNode(
              "div",
              _hoisted_2,
              toDisplayString(unref$1(t)("layouts.hierarchy_view.parent_field")),
              1
              /* TEXT */
            ),
            createVNode(_component_v_select, {
              modelValue: unref$1(optParentFieldWritable),
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isRef(optParentFieldWritable) ? optParentFieldWritable.value = $event : null),
              "show-deselect": "",
              "item-value": "field",
              "item-text": "name",
              items: _ctx.relationFields
          ...
          createElementVNode("div", _hoisted_3, [
            createElementVNode(
              "div",
              _hoisted_4,
              toDisplayString(unref$1(t)("layouts.hierarchy_view.title_field")),
              1
              /* TEXT */
            ),
            createVNode(_component_v_collection_field_template, {
              modelValue: unref$1(optTitleWritable),
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isRef(optTitleWritable) ? optTitleWritable.value = $event : null),
              collection: _ctx.collection
...
var ForestOptions = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "hierarchy-options.vue"]]);

function syncRefProperty(ref, key, defaultValue) {
  return computed({
    get() {
      var _a, _b;
      return (_b = (_a = ref.value) == null ? void 0 : _a[key]) != null ? _b : unref$1(defaultValue);
    },
    set(value) {
...
var index = defineLayout({
  ...
  setup(props, { emit }) {
    ...
    function useLayoutQuery() {
      const page2 = syncRefProperty(layoutQuery, "page", 1);
      const limit2 = syncRefProperty(layoutQuery, "limit", -1);
      const defaultSort = computed(() => {
        var _a;
        return primaryKeyField.value ? [(_a = primaryKeyField.value) == null ? void 0 : _a.field] : [];
      });
      const sort2 = syncRefProperty(layoutQuery, "sort", defaultSort);
      const fields2 = computed(() => {
        if (!primaryKeyField.value || !props.collection)
          return [];
        const fields3 = [
        ...
        if (info.value.meta.sort_field) {
          fields3.push(info.value.meta.sort_field);
        }
        if (optTitle.value) {
          fields3.push(
      ...
      return { sort: sort2, limit: limit2, page: page2, fields: fields2 };
    }
    function useLayoutOptions() {
      const optParentField2 = createViewOption("parentField", "parent");
      const optTitle2 = createViewOption("title", "{{name}}");
      return {
        optParentField: optParentField2,
        optTitle: optTitle2
      };
      function createViewOption(key, defaultValue) {
        return computed({
          get() {
            var _a;
            return ((_a = layoutOptions.value) == null ? void 0 : _a[key]) !== void 0 ? layoutOptions.value[key] : defaultValue;
          },
          set(newValue) {
            layoutOptions.value = {
              ...layoutOptions.value,
    ...
    const relationFields = computed(() => {
      return fieldsInCollection.value.filter((field) => {
        var _a;
        return ((_a = field.schema) == null ? void 0 : _a.foreign_key_table) === props.collection;
      });
    });
    ...
    const { items, loading, error, totalPages, itemCount, totalCount, getItems, getTotalCount, getItemCount } = useItems(collection, {
      sort,
      limit,
      page,
      fields,
    ...
    function onItemClick({ item, event }) {
      ...
      if (props.selectMode || ((_a = selection.value) == null ? void 0 : _a.length) > 0) {
        if (((_b = selection.value) == null ? void 0 : _b.includes(primaryKey)) === false) {
          selection.value = selection.value.concat(primaryKey);
        } else {
          selection.value = selection.value.filter((item2) => item2 !== primaryKey);
        }
      } else {
